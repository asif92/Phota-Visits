...
<body class="hold-transition skin-blue sidebar-mini">
    <div id="app" >
        @if (Auth::guest())
        @else
        @include('DG.Partials.header')
        @endif
        <div class="row">
            @include('DG.Partials.aside')
        </div>
        <div class="content-wrapper">
            <!-- <img src="{{asset('images/govlogo.png')}}" class="gop_logo"> -->
            @yield('content')
        </div>
    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('DG.Partials.participantForm')
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="add_new_user" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('DG.Partials.newUserForm')
                </div>
            </div>
        </div>
    </div>
    ...
    <div id="add_new_vehicle" class="modal fade" role="dialog">
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    @include('DG.Partials.newVehicleForm')
                </div>
            </div>
        </div>
    </div>
