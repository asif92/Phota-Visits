<form  action="/addEvent" method="post" id="meeting_add_form">
	{{ csrf_field() }}
	...
	<div class="row form-group">
		...
		<div class="col-lg-8">
			<textarea name="event_description" class="form-control" placeholder="{{$event_name}} Agenda" minlength="5" title="Use Minimum 5 letters.">
			</textarea>
		</div>
	</div>
	...
	<div class="row form-group">
		...
		<div class="col-lg-8">
			<input type="text" name="event_venue" class="form-control" placeholder="{{$event_name}} Venue" maxlength="150" minlength="5">
		</div>
	</div>
	<div class="row form-group">
		...
		<div class="col-sm-4 col-md-4 col-lg-4">
			...
			<div class="input-group bootstrap-timepicker timepicker">
				<input id="timepicker1" type="text" name= "event_time" class="form-control input-small" readonly="true" required="true" >
