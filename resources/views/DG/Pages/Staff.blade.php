		...
		<tbody>
			...
			<tr style="background-color:lightpink;">
				...
				<tr style="background-color:lightgray;">
					...
					<td>{{$eParticipant->participant->participant_address}}</td>
					<td>
						...
						<button class="btn btn-danger btn-xs">
							<a href="/deleteParticipant/{{$eParticipant->participant->id}}" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
						</button>
					</td>
				</tr>
				@endforeach
